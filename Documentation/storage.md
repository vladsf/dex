...
* `github.com/concourse/dex/storage`: Interface definitions which the storage must implement. __NOTE:__ This package is not stable.
* `github.com/concourse/dex/storage/conformance`: Conformance tests which storage implementations must pass.
...
[issues-transaction-tests]: https://github.com/concourse/dex/issues/600
